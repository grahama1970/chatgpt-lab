...
| Control-plane source check | `PASS` | Source check run `28243281032` passed after live proof commit `fee9b0ed568861825e23dbf46748062d549573e7`. |
...
| Monocle Man benchmark CI | `PASS` | Benchmark run `28243059075` passed at head SHA `05e2ea40f5be30c8b4c494f362cf7624caa408b8`. |
| Monocle Man GitHub Pages workflow | `PASS` | Pages run `28243097448` passed at head SHA `05e2ea40f5be30c8b4c494f362cf7624caa408b8`; build job, configure/upload Pages, deploy, Playwright live proof, artifact upload, and proof commit all succeeded. |
...
- Live proof commit: `fee9b0ed568861825e23dbf46748062d549573e7`
- Live site: `https://grahama1970.github.io/chatgpt-lab/`
- GitHub Pages live proof run: `https://github.com/grahama1970/chatgpt-lab/actions/runs/28243097448`
- Benchmark run: `https://github.com/grahama1970/chatgpt-lab/actions/runs/28243059075`
- Source check run: `https://github.com/grahama1970/chatgpt-lab/actions/runs/28243281032`
