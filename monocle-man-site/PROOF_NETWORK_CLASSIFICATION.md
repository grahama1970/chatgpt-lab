...
- the request is YouTube embed lifecycle traffic at `/api/stats/qoe`, `/youtubei/v1/log_event`, or `/youtubei/v1/next`, the iframe document under `/embed/NBxByrz5BRE`, or a no-cookie embed script under `/s/_/ytembeds/_/js/`.
