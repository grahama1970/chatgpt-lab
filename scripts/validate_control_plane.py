...
REQUIRED_FILES = (
    ...
    "docs/requirements/GOAL_LOCKED_AGENT_HARNESS.md",
    ...
    "schemas/github-thread-fixture.schema.json",
    "schemas/tau-agent-handoff.schema.json",
    "schemas/tau-generated-ticket.schema.json",
    "schemas/tau-human-goal-change.schema.json",
    ...
    "schemas/pr-local-task.schema.json",
    ...
    "iterations/templates/pr-local-task.example.json",
    "iterations/templates/pr-local-task-refusal.example.json",
    "examples/agent-harness/agent-handoff.valid.json",
    "examples/agent-harness/human-interjection.pause.valid.json",
    "examples/agent-harness/generated-ticket.valid.json",
    "examples/agent-harness/fixtures/issue-human-interjection-preserve-goal.json",
    "examples/agent-harness/fixtures/issue-human-interjection-goal-change.json",
    "examples/agent-harness/fixtures/issue-missing-next-subagent.json",
    "examples/agent-harness/fixtures/issue-generated-ticket-goal-mismatch.json",
    "examples/agent-harness/fixtures/issue-legacy-phatgpt-task-detected.json",
    "examples/agent-harness/tau/tau-agent-handoff.valid.json",
    "examples/agent-harness/tau/tau-generated-ticket.valid.json",
    "examples/agent-harness/tau/tau-human-goal-change.valid.json",
    "examples/agent-harness/github-state/pr-13-gh-view.json",
    "examples/agent-harness/github-state/issue-14-tau-comment-gh-view.json",
    "scripts/goal_contracts.py",
    "scripts/agent_ticket_route.py",
    "scripts/agent_ticket_orchestrator.py",
    "scripts/tau_contracts.py",
    "scripts/validate_goal_capsule.py",
    "scripts/validate_agent_ticket_contracts.py",
    "scripts/validate_agent_ticket_route.py",
    "scripts/validate_tau_contracts.py",
    "scripts/validate_agent_ticket_orchestrator.py",
    "scripts/validate_iteration.py",
    "scripts/validate_benchmark_evidence.py",
    "scripts/validate_local_subagent_contract.py",
    "scripts/validate_pr_local_task.py",
    "scripts/validate_agent_state.py",
    "scripts/apply_text_patch.py",
    "scripts/write_workflow_result.py",
    "scripts/phatgpt_capability_inventory.py",
    "scripts/phatgpt_stress_test_plan.py",
    ...
    "scripts/phatgpt_watchdog_cycle.py",
    "scripts/run_phatgpt_watchdog.sh",
    "scripts/install_phatgpt_watchdog_cron.sh",
    "scripts/update_controller_state.py",
    "tests/test_goal_capsule.py",
    "tests/test_agent_ticket_contracts.py",
    "tests/test_agent_ticket_route.py",
    "tests/test_tau_contracts.py",
    "tests/test_agent_ticket_orchestrator.py",
